...
class ESLTeacherCLI:
    ...
    def display_splash_screen(self):
        ...
        self.console.print("Version 1.0.0", style="cyan", justify="center")
    ...
    def list_lessons(self):
        ...
        for l in lessons:
            grammar = l["grammar_focus"] or "None"
            if len(grammar) > 30:
                grammar = grammar[:27] + "..."

            vocab = l["vocabulary_focus"] or "None"
            if len(vocab) > 30:
                vocab = vocab[:27] + "..."

            status_style = "green bold" if l["status"] == "Completed" else "yellow"
    ...
    def display_block_details(self):
        ...
        activity_text.append(
            f"{self.current_block['activity_type'] or 'Not specified'}", style="yellow"
        )
